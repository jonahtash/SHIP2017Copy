<%@ Page Title="Search"Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SHIPSite.WebForm3" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="MainContent">
    ...
    <div aria-orientation="vertical" style="height: 491px; text-align: center; margin: 0 auto; clip: rect(auto, 0px, auto, auto);">
            ...
            <asp:TextBox ID="SearchText" runat="server" Height="50px" CssClass="padding" AutoPostback="False" OnClick="searchText_click()" Style ="display: inline;">Search...</asp:TextBox>
    ...
    ShowOnlyCurrentWordInCompletionListItem="true" CompletionListItemCssClass="drop" CompletionListHighlightedItemCssClass="drop_highlight" >
                    ...
                    <asp:Button ID="Submit" runat="server" BackColor="#0099FF" BorderStyle="None" Height="50px" Text="Go" Width="65px" onclick="Submit_Click" CssClass="SubmitButton" Style="border-top-right-radius: 50px;border-bottom-right-radius: 50px;"/>
